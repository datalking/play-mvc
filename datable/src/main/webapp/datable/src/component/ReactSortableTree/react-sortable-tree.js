...
const mergeTheme = props => {
    ...
    const merged = {
        ...
        reactVirtualizedListProps: {...props.theme.reactVirtualizedListProps, ...props.reactVirtualizedListProps,},
    };
...
class ReactSortableTree extends Component {
    ...
    componentDidMount() {
        ...
        // TODO: This is very brittle, so it needs to be replaced if react-dnd offers a more official way to detect when a drag ends
        this.clearMonitorSubscription = this.props.dragDropManager
            .getMonitor()
            .subscribeToStateChange(this.handleDndMonitorChange);
    }

    // 用来替换componentWillReceiveProps，内部不要有副作用
    ...
    /**
     *  ReactSortableTree的render
     */
    render() {

        // console.log('====props4tree');
        // console.log(this.props);

        const mergedTheme = mergeTheme(this.props);
